...
<div style="position: relative; display: flex;">     
      <input type="text" class="form-control rounded" placeholder="Search for...">
        	<button type="submit" id="searchsubmit" value="<?php esc_attr_x('Search', 'b4st') ?>" class="btn btn-outline-info my-2 my-sm-0 ml-1"><i class="fa fa-search"></i></button>
    </div>
 </form>
