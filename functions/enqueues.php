...
function roman_temple_enqueues() {
    ...
    // Register
    wp_register_script('jquery-migrate', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-migrate/3.0.0/jquery-migrate.min.js', array('jquery'), '3.0.0'); // require jquery, as loaded above
	...
	wp_register_script('bootstrap-js', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/js/bootstrap.min.js', false, '4.0.0-alpha.6', true);
  	// wp_register_script('bootstrap-js', get_template_directory_uri() . '/javascripts/bootstrap.min.js', false, '4.0.0-alpha.6', true);
...
add_action('wp_enqueue_scripts', 'roman_temple_enqueues', 100);
